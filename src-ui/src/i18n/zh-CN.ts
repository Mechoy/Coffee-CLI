export const zhCN = {
  ...
  'mcp.none': '不启用',
  'mcp.inherit': '继承全局',
  'mcp.id.exists': '该标识符已存在：',
  'mcp.reload': '重新加载',
  'mcp.repair.invalid': '重置损坏配置',
  'mcp.id': '标识符',
  'mcp.name': '名称',
  'mcp.command': '启动命令',
  'mcp.arguments': '参数',
  'mcp.environment': '环境变量映射',
  'mcp.headers': '请求头环境变量映射',
  'mcp.enabled': '启用',
  'mcp.save': '保存',
  'mcp.delete': '删除',
  'mcp.server.add': '添加服务',
  'mcp.server.empty': '选择一个服务或新建服务。',
  'mcp.server.used': '该服务正在被以下配置组使用：',
  'mcp.profile.add': '添加配置组',
  'mcp.profile.empty': '选择一个配置组或新建配置组。',
  'mcp.profile.servers': '配置组中的服务',
  'mcp.default.global': '全局',
  'mcp.workspace.bindings': '工作区默认配置',
  'mcp.workspace.add': '添加工作区',
  'mcp.wrapper.warning': '{tool} 经由 {wrapper} 启动，可能无法访问宿主机 MCP。',
  'skills.loading': '正在加载 Skills...',
  'skills.personal': '个人原生 Skills',
  'skills.refresh': '刷新',
  'skills.reload': '重新加载',
  'skills.add': '新建 Skill',
  'skills.empty': '选择一个 Skill 或新建。',
  'skills.id': '标识符',
  'skills.id.required': '请输入有效的 Skill 标识符，或填写可生成标识符的名称。',
  'skills.name': '名称',
  'skills.name.placeholder': '研究摘要',
  'skills.description': '描述',
  'skills.description.placeholder': '简短说明此 Skill 的能力。',
  'skills.body': 'SKILL.md 正文',
  'skills.body.placeholder': '编写此 Skill 的工作说明...',
  'skills.enable': '启用',
  'skills.disable': '禁用',
  'skills.sync': '同步',
  'skills.save': '保存',
  'skills.delete': '删除',
  'skills.delete.confirm': '删除此 Coffee 托管的 Skill？请先禁用其原生目标安装项。',
  'skills.working': '处理中...',
  'skills.future.sessions': '将在后续新建的原生 Agent 会话中可用。',
  'skills.state.disabled': '已禁用',
  'skills.state.enabled_linked': '已启用',
  'skills.state.enabled_copied': '已启用（副本）',
  'skills.state.needs_sync': '需要同步',
  'skills.state.conflict': '路径冲突',
  'skills.state.drift': '外部改动',
  'skills.state.source_missing': '源文件缺失',
  'skills.state.error': '检查失败',
